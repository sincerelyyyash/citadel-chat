...
export function PulseLoader({
  ...
  return (
    <div className={cn("relative", sizeClasses[size], className)}>
      <div className="absolute inset-0 rounded-full border-2 border-muted-foreground/30 animate-[thin-pulse_1.5s_ease-in-out_infinite]" />
      <span className="sr-only">Loading</span>
    </div>
  )
}
...
export function TextBlinkLoader({
  ...
  return (
    <div
      className={cn(
        "animate-[text-blink_2s_ease-in-out_infinite] font-medium text-muted-foreground",
        textSizes[size],
        className
      )}
    >
