...
const ReactRenderer = memo(({ code }: { code: string }) => {
    return (
        <div className="flex h-96 w-full flex-col items-center justify-center space-y-2 rounded-md border border-border bg-secondary/30 p-8 text-center text-muted-foreground">
            <p className="font-medium text-foreground text-sm">Interactive Preview Disabled</p>
            <p className="text-xs">
                Live execution of React components is not supported in this environment.
            </p>
        </div>
    )
})
