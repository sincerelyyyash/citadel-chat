    ...
    return (
        <div className="flex h-screen flex-col overflow-y-auto bg-background">
            <div className="container mx-auto px-4 py-12 md:py-24 lg:max-w-4xl">
                ...
                <h1 className="mb-6 font-bold text-3xl">Citadel Privacy Policy</h1>
                <p className="mb-8 text-muted-foreground text-sm">Last Updated: 21 March 2026</p>
                ...
                <section className="mb-8 space-y-4">
                    ...
                    <p className="text-muted-foreground">
                        ...
                        reach out at{" "}
                        <a
                            href="mailto:sincerelyyyash@gmail.com"
                            className="text-primary hover:underline"
                        >
                           sincerelyyyash@gmail.com
                        </a>
                    </p>
                </section>
