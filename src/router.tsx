import { ThemedGlobalNotFound, ThemedRouterError } from "@/components/themed-route-states"
...
export function createRouter() {
    const router = routerWithQueryClient(
        createTanStackRouter({
            ...
            context: { queryClient },
            defaultNotFoundComponent: ThemedGlobalNotFound,
            defaultErrorComponent: ThemedRouterError,
            Wrap: ({ children }) => (
